...
public class TraderListAdapter extends RecyclerView.Adapter<TraderListAdapter.TraderViewHolder> {
    private final Context context;
    private final List<Trader> traderList;
    private final String currentUserId;

    public TraderListAdapter(Context context, List<Trader> traderList, String currentUserId) {
    ...
    public TraderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_traders_list, parent, false);
    ...
    public int getItemCount() {
        return traderList != null ? traderList.size() : 0;
    }

    public static class TraderViewHolder extends RecyclerView.ViewHolder {
        TextView traderNameTextView, shopNameTextView, shopAddressTextView, phoneNumberTextView, ratingTextView;
        RatingBar ratingBar;
