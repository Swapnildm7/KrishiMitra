        ...
        databaseReference.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    CustomSpinnerAdapter talukaAdapter = new CustomSpinnerAdapter(TraderProfileActivity.this, talukas.toArray(new String[0]));
                                                    ...
                                                    userRef.removeValue()
                                                            .addOnCompleteListener(deleteTask -> {
                                                                if (deleteTask.isSuccessful()) {
                                                                    Toast.makeText(TraderProfileActivity.this, "Account deleted and moved to past users.", Toast.LENGTH_SHORT).show();
                                                                    ...
                                                                    Toast.makeText(TraderProfileActivity.this, "Failed to delete account from Users node", Toast.LENGTH_SHORT).show();
                                                                }
                                                            });
                                                } else {
